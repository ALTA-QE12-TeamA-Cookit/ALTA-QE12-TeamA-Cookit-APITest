...
#    update image by recipe_id and image_id
  @Positive
  Scenario: Update images into recipe with valid recipe_id and valid image_id and valid body
  ...
  @Negative
  Scenario: Update images into recipe with valid recipe_id and image_id isn't exists and valid body
  ...
  @Negative
  Scenario: Update images into recipe with valid recipe_id and image_id inputted by alphabet and valid body
  ...
  @Negative
  Scenario: Update images into recipe with valid recipe_id and valid image_id and without key image
  ...
  @Negative
  Scenario: Update images into recipe with valid recipe_id and valid image_id and without image
  ...
  @Negative
  Scenario: Update images into recipe with valid recipe_id and valid image_id and valid body without token
...
#    Delete image with recipe_id and image_id
  ...
  @Negative
  Scenario: Delete specific image with valid recipe_id and image_id isn't exists
  ...
  @Negative
  Scenario: Delete specific image with valid recipe_id and image_id inputted by alphabet
  ...
  @Negative
  Scenario: Delete specific image with valid recipe_id and valid image_id without token
  ...
  @Positive
  Scenario: Delete images into recipe with valid recipe_id and valid image_id
